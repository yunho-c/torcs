...
if(NOT DEFINED TORCS_BRIDGE_HARNESS_ARGS)
	set(TORCS_BRIDGE_HARNESS_ARGS "")
endif()
...
execute_process(
	COMMAND "${TORCS_BRIDGE_HARNESS}" ${TORCS_BRIDGE_HARNESS_ARGS} --seconds 0.12 --sample-seconds 0.02 --output "${first_output}"
...
execute_process(
	COMMAND "${TORCS_BRIDGE_HARNESS}" ${TORCS_BRIDGE_HARNESS_ARGS} --seconds 0.12 --sample-seconds 0.02 --output "${second_output}"
